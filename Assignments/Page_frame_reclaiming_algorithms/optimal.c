/* not something we are able to use in practice */
/* not efficient bc when it is time toi evict a page we will go through all pages in memory and check how far down the sequence of references that it is found. Page with highets value is selected */
